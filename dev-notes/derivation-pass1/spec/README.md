...
- `bindings.md` — domain bindings (incl. the verification battery
  and dispatch-isolation binding)
...
the §1 fit verdict, the lens-set path, the judgment calls, and the
**contract-1 strain findings** — where the framework's fixed method
strained against this domain. It is derivation commentary, not a
